...
internal class RegisterVerificationServiceTest
{
	...
	public static IEnumerable<TestCaseData> TestAllowsValidPasswordSource()
	{
		...
		yield return new TestCaseData(new RegisterAccountDTO { Username = "aae", Password = "Password123", Email = "myMail@Gmail.com" }, RegistrationState.Failure) { TestName = "Invalid: Username too short" };
		yield return new TestCaseData(new RegisterAccountDTO { Username = "successName", Password = "adas", Email = "myMail@Gmail.com" }, RegistrationState.Failure) { TestName = "Invalid: Password too short" };
		...
		yield return new TestCaseData(new RegisterAccountDTO { Username = "successName", Password = "PasswordIsCool", Email = "myMail@Gmail.com" }, RegistrationState.Failure) { TestName = "Invalid: Password too simple" };
		yield return new TestCaseData(new RegisterAccountDTO { Username = "successName", Password = "InvalidCharacter", Email = "myMail@Gmail.com" }, RegistrationState.Failure) { TestName = "Invalid: Password too simple" };
	}
}