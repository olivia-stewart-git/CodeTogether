...
public class StatsController(ApplicationDbContext dbContext) : Controller
{
	...
	public IActionResult GetStats()
	{
		...
		// Safe to silence nullable warning because its evaluated as an sql join rather than in .net https://stackoverflow.com/a/77874658
	...
	public IActionResult GetGames(int pageNum, int pageSize)
	{
		...
		return Ok(relevant.Select(g => new GameResultDTO
		{
			...
			WinnerUsername = g.GM_WinningSubmission!.SBM_SubmittedBy.GMP_User.USR_UserName ?? "No Winner",
